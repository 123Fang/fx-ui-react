...
export default function Dedicate() {
  return <div className="dedicateInner">
    <Title title="贡献指南" notes="" desc="fx-ui-react 是基于 React+Ts 开发，并集成vite构建。fx-ui-react 旨在秉承数据驱动视图，力求更小的体积、更快的相应、更强的拓展性、更完美的支持、更友好的渲染。任何一个开源库都离不开大家的共同贡献和维护，欢迎加入，大家一起学习进步！" />
    ...
    <div className="line2">
      ...
      <li className="line-li">如果您在使用中存在 bug 或者有更超前的思想及解决方案，不限于新的组件、新的模式，您可以在 Issue 提交问题，我会定时进行维护并回复</li>
    </div>
    <div className="line2">
