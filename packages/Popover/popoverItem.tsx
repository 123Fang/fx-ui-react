    ...
    >
      ...
      >
        <div
          className={classNames(
            'fx_popover_content',
            `fx_popover_content_${placement}`
          )}
        >
          <div
            className={classNames(
              'fx_popover_arrow',
              `fx_popover_arrow_${placement}`
            )}
            style={arrowStyle}
          />
          <div className="fx_popover_inner">
            <div className="fx_popover_title">{title}</div>
            <div className="fx_popover_inner_content">{content}</div>
          </div>
        </div>
      </div>
    </CSSTransition>
